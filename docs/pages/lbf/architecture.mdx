...
# LBF Technical Architecture

LBF is a fully decentralised cross-chain bridging framework enabling seamless value transfer across different blockchain networks.
